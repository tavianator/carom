...
namespace carom
{
  ...
  inline scalar_proxy<0, 0, 0, s_proxy<scalar_pi_op> >
  pi()
  { return scalar_proxy<0, 0, 0, s_proxy<scalar_pi_op> >(); }

  // Unary operators

  template <int m, int d, int t>
  inline scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_pos_op> >
  operator+(const scalar_units<m, d, t>& n)
  { return scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_pos_op> >(n); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, ss_proxy<op, scalar_pos_op> >
  operator+(const scalar_proxy<m, d, t, op>& n)
  { return scalar_proxy<m, d, t, ss_proxy<op, scalar_pos_op> >(n); }

  template <int m, int d, int t>
  inline scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_neg_op> >
  operator-(const scalar_units<m, d, t>& n)
  { return scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_neg_op> >(n); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, ss_proxy<op, scalar_neg_op> >
  operator-(const scalar_proxy<m, d, t, op>& n)
  { return scalar_proxy<m, d, t, ss_proxy<op, scalar_neg_op> >(n); }
  ...
  template <int m, int d, int t>
  inline scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_sin_op> >
  sin(const scalar_units<m, d, t>& n)
  { return scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_sin_op> >(n); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, ss_proxy<op, scalar_sin_op> >
  sin(const scalar_proxy<m, d, t, op>& n)
  { return scalar_proxy<m, d, t, ss_proxy<op, scalar_sin_op> >(n); }

  template <int m, int d, int t>
  inline scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_cos_op> >
  cos(const scalar_units<m, d, t>& n)
  { return scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_cos_op> >(n); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, ss_proxy<op, scalar_cos_op> >
  cos(const scalar_proxy<m, d, t, op>& n)
  { return scalar_proxy<m, d, t, ss_proxy<op, scalar_cos_op> >(n); }

  template <int m, int d, int t>
  inline scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_tan_op> >
  tan(const scalar_units<m, d, t>& n)
  { return scalar_proxy<m, d, t, ss_proxy<mpfr_t, scalar_tan_op> >(n); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, ss_proxy<op, scalar_tan_op> >
  tan(const scalar_proxy<m, d, t, op>& n)
  { return scalar_proxy<m, d, t, ss_proxy<op, scalar_tan_op> >(n); }
  ...
  { return scalar_proxy<m, d, t,
                        sss_proxy<mpfr_t, mpfr_t, scalar_add_op> >(lhs, rhs); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, sss_proxy<mpfr_t, op, scalar_add_op> >
  operator+(const scalar_units<m, d, t>& lhs,
            const scalar_proxy<m, d, t, op>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<mpfr_t, op, scalar_add_op> >(lhs, rhs); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, sss_proxy<op, mpfr_t, scalar_add_op> >
  operator+(const scalar_proxy<m, d, t, op>& lhs,
            const scalar_units<m, d, t>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<op, mpfr_t, scalar_add_op> >(lhs, rhs); }

  template <int m, int d, int t, typename op1, typename op2>
  inline scalar_proxy<m, d, t, sss_proxy<op1, op2, scalar_add_op> >
  operator+(const scalar_proxy<m, d, t, op1>& lhs,
            const scalar_proxy<m, d, t, op2>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<op1, op2, scalar_add_op> >(lhs, rhs); }
  ...
  operator-(const scalar_units<m, d, t>& lhs,
            const scalar_units<m, d, t>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<mpfr_t, mpfr_t, scalar_sub_op> >(lhs, rhs); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, sss_proxy<mpfr_t, op, scalar_sub_op> >
  operator-(const scalar_units<m, d, t>& lhs,
            const scalar_proxy<m, d, t, op>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<mpfr_t, op, scalar_sub_op> >(lhs, rhs); }

  template <int m, int d, int t, typename op>
  inline scalar_proxy<m, d, t, sss_proxy<op, mpfr_t, scalar_sub_op> >
  operator-(const scalar_proxy<m, d, t, op>& lhs,
            const scalar_units<m, d, t>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<op, mpfr_t, scalar_sub_op> >(lhs, rhs); }

  template <int m, int d, int t, typename op1, typename op2>
  inline scalar_proxy<m, d, t, sss_proxy<op1, op2, scalar_sub_op> >
  operator-(const scalar_proxy<m, d, t, op1>& lhs,
            const scalar_proxy<m, d, t, op2>& rhs)
  { return scalar_proxy<m, d, t,
                        sss_proxy<op1, op2, scalar_sub_op> >(lhs, rhs); }

  // Multiplication operators

  template <int m1, int m2, int d1, int d2, int t1, int t2>
  inline scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                      sss_proxy<mpfr_t, mpfr_t, scalar_mul_op> >
  operator*(const scalar_units<m1, d1, t1>& lhs,
            const scalar_units<m2, d2, t2>& rhs)
  { return scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                        sss_proxy<mpfr_t, mpfr_t, scalar_mul_op> >(lhs, rhs); }

  template <int m1, int m2, int d1, int d2, int t1, int t2, typename op>
  inline scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                      sss_proxy<mpfr_t, op, scalar_mul_op> >
  operator*(const scalar_units<m1, d1, t1>& lhs,
            const scalar_proxy<m2, d2, t2, op>& rhs)
  { return scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                        sss_proxy<mpfr_t, op, scalar_mul_op> >(lhs, rhs); }

  template <int m1, int m2, int d1, int d2, int t1, int t2, typename op>
  inline scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                      sss_proxy<op, mpfr_t, scalar_mul_op> >
  operator*(const scalar_proxy<m1, d1, t1, op>& lhs,
            const scalar_units<m2, d2, t2>& rhs)
  { return scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                        sss_proxy<op, mpfr_t, scalar_mul_op> >(lhs, rhs); }

  template <int m1, int m2, int d1, int d2, int t1, int t2,
	    typename op1, typename op2>
  inline scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                      sss_proxy<op1, op2, scalar_mul_op> >
  operator*(const scalar_proxy<m1, d1, t1, op1>& lhs,
            const scalar_proxy<m2, d2, t2, op2>& rhs)
  { return scalar_proxy<m1 + m2, d1 + d2, t1 + t2,
                        sss_proxy<op1, op2, scalar_mul_op> >(lhs, rhs); }

  // Division operators

  template <int m1, int m2, int d1, int d2, int t1, int t2>
  inline scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                      sss_proxy<mpfr_t, mpfr_t, scalar_div_op> >
  operator/(const scalar_units<m1, d1, t1>& lhs,
            const scalar_units<m2, d2, t2>& rhs)
  { return scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                        sss_proxy<mpfr_t, mpfr_t, scalar_div_op> >(lhs, rhs); }

  template <int m1, int m2, int d1, int d2, int t1, int t2, typename op>
  inline scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                      sss_proxy<mpfr_t, op, scalar_div_op> >
  operator/(const scalar_units<m1, d1, t1>& lhs,
            const scalar_proxy<m2, d2, t2, op>& rhs)
  { return scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                        sss_proxy<mpfr_t, op, scalar_div_op> >(lhs, rhs); }

  template <int m1, int m2, int d1, int d2, int t1, int t2, typename op>
  inline scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                      sss_proxy<op, mpfr_t, scalar_div_op> >
  operator/(const scalar_proxy<m1, d1, t1, op>& lhs,
            const scalar_units<m2, d2, t2>& rhs)
  { return scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                        sss_proxy<op, mpfr_t, scalar_div_op> >(lhs, rhs); }

  template <int m1, int m2, int d1, int d2, int t1, int t2,
	    typename op1, typename op2>
  inline scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
                      sss_proxy<op1, op2, scalar_div_op> >
  operator/(const scalar_proxy<m1, d1, t1, op1>& lhs,
            const scalar_proxy<m2, d2, t2, op2>& rhs)
  { return scalar_proxy<m1 - m2, d1 - d2, t1 - t2,
